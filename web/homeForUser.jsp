                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <c:forEach var="r" items="${requestScope.LIST_ROOM}" varStatus="count">
                                            <tr>
                                                ...
                                                <td>${r.typeId}</td> 
                                                <td>${r.price}</td>
                                                <td><a href="MainController?btnAction=viewDetailRoom&hotelId=${r.hotelId}&roomNo=${r.roomNo}" class="ico edit">Order</a></td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <div id="sidebar">
                        ...
                        <div class="box">
                            <form action="MainController">
                                ...
                                <!-- End Sort -->
                                <button name="btnAction" value="SearchRoom" class="btn btn-primary" style="width: 100%">Search</button>
                            </form>
                        </div>
